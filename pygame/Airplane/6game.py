...
class GameBackground:
    ...
    def __init__(self, scene):
        # 加载相同张图片资源,做交替实现地图滚动
        self.image1 = pygame.image.load("D:/Desktop/pygame/Airplane/images/plane/map.jpg")
...
class Plane:
    ...
    def __init__(self, scene):
        # 加载飞机外观图片
        self.image.append(pygame.image.load("D:/Desktop/pygame/Airplane/images/plane/plane.png"))
        self.image.append(pygame.image.load("D:/Desktop/pygame/Airplane/images/plane/plane_left.png"))
        self.image.append(pygame.image.load("D:/Desktop/pygame/Airplane/images/plane/plane_right.png"))

        # 加载飞机子弹图片
        self.bullet_image = pygame.image.load("D:/Desktop/pygame/Airplane/images/plane/bullet.png")
...
class MainScene:
    ...
    def __init__(self):
        ...
        # 加载敌机外形图片
        for n in range(4):
            # self.enemy_images.append(pygame.image.load("D:/Desktop/pygame/Airplane/images/plane/enemy/e_" + str(n + 1) + ".png"))
            self.enemy_images.append(pygame.image.load("images/plane/enemy/e_" + str(n + 1) + ".png"))
        # 加载敌机子弹图片
        self.enemy_bullet = pygame.image.load("D:/Desktop/pygame/Airplane/images/plane/enemy_bullet.png")
        # 缩小敌机子弹图片为原来的一半
        ...
        # 加载爆炸效果图片
        for n in range(6):
            self.boom_images.append(pygame.image.load("D:/Desktop/pygame/Airplane/images/plane/boom/b" + str(n + 1) + ".png"))
        # Game Over的背景图
        self.game_over_image = pygame.image.load("D:/Desktop/pygame/Airplane/images/plane/gameover.png")

        # 加载声音文件
        self.game_music = pygame.mixer.Sound("D:/Desktop/pygame/Airplane/music/game_music.wav")
        self.boom_sound = pygame.mixer.Sound("D:/Desktop/pygame/Airplane/sounds/plane/boom.wav")
        self.bullet_sound = pygame.mixer.Sound("D:/Desktop/pygame/Airplane/sounds/plane/bullet.wav")
        self.enemy_bullet_sound = pygame.mixer.Sound("D:/Desktop/pygame/Airplane/sounds/plane/enemy_bullet.wav")
        self.over_sound = pygame.mixer.Sound("D:/Desktop/pygame/Airplane/sounds/plane/game_over.wav")
    ...
    def draw_elements(self):
        if not self.plane.isHit:
            ...
            # 绘制得分
            font = pygame.font.Font("D:/Desktop/pygame/Airplane/fonts/katong.ttf", 30)
